    ...
    <div className={cx('shareButton', bottom ? 'withoutBg' : '', className)}>
      ...
      <div className="withoutFill hover:opacity-80" onClick={copy}>
        <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          />
          <path
            d="M15.1536 18.1035C14.8493 17.8053 14.6075 17.4494 14.4424 17.0566C14.2774 16.6638 14.1924 16.2421 14.1924 15.816C14.1924 15.39 14.2774 14.9682 14.4424 14.5754C14.6075 14.1827 14.8493 13.8268 15.1536 13.5286L17.7246 10.9575C18.0228 10.6532 18.3787 10.4114 18.7715 10.2464C19.1643 10.0814 19.586 9.99634 20.0121 9.99634C20.4381 9.99634 20.8599 10.0814 21.2527 10.2464C21.6454 10.4114 22.0013 10.6532 22.2995 10.9575C22.6038 11.2557 22.8456 11.6116 23.0106 12.0044C23.1757 12.3971 23.2607 12.8189 23.2607 13.245C23.2607 13.671 23.1757 14.0928 23.0106 14.4855C22.8456 14.8783 22.6038 15.2342 22.2995 15.5324L21.5126 16.3193"
            stroke="white"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      <a
        ...
        href={
          'mailto:?subject=' +
          title +
          '&body= %0D Сайн байна уу? %0D%0D Энэ маш хэрэгтэй мэдээлэл байна.%0D%0D' +
          url +
          '%0D%0D Өдрөө сайхан өнгөрүүлээрэй'
        }
      >
        <svg width="19" height="17" viewBox="0 0 19 17" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_3424_28885)">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M16.4528 0.998779L2.32896 0.998779C1.35794 0.998779 0.563477 1.8987 0.563477 2.9986L0.563477 14.9975C0.563477 16.0974 1.35794 16.9973 2.32896 16.9973H16.4528C17.4238 16.9973 18.2183 16.0974 18.2183 14.9975V2.9986C18.2183 1.8987 17.4238 0.998779 16.4528 0.998779ZM16.4528 4.57627C16.4528 4.84104 16.3243 5.08935 16.1082 5.24234L11.1243 8.77076C10.0857 9.50609 8.69608 9.50609 7.65743 8.77076L2.6735 5.24234C2.4574 5.08935 2.32896 4.84104 2.32896 4.57627V4.57627C2.32896 3.91405 3.07612 3.52756 3.6166 3.9102L7.65743 6.77094C8.69608 7.50627 10.0857 7.50627 11.1243 6.77094L15.1651 3.9102C15.7056 3.52756 16.4528 3.91405 16.4528 4.57627V4.57627Z"
              fill="white"
            />
          </g>
          <defs>
            <clipPath id="clip0_3424_28885">
              <rect width="17.6548" height="15.9986" fill="white" transform="translate(0.563477 0.998779)" />
            </clipPath>
          </defs>
        </svg>
      </a>
